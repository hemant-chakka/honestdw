						...
						<div class="row">
							...
							<div class="col-md-10">
								...
								<div class="row">
									...
									<div class="col-md-2">&nbsp;</div>
									<div class="col-md-2"><a class="btn btn-primary btn-sm" href="/get-prices/payPendingSubmission/$ID" role="button">Pay</a></div>
									<div class="col-md-4">&nbsp;</div>
								</div>

								<div class="row">
									<div class="col-md-4"><p>Price: ${$PriceSubmitted}</p></div>
									<div class="col-md-8">&nbsp;</div>
								</div>
						
								<div class="row">
									<div class="col-md-4"><p>Client: $Tender.Client.Name</p></div>
									<div class="col-md-8">
										<% loop $Tender.Client %>
