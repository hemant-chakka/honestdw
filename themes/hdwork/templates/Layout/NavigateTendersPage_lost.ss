<section>
   <div id="NavTenders" class="container">
		...
		<% if $LostTenders %>
			<% loop $LostTenders %>
						<div class="row">
							...
							<div class="col-md-10">
								...
								<div class="row">
									<div class="col-md-4"><p>My Price: ${$PriceSubmitted}</p></div>
									<div class="col-md-8">&nbsp;</div>
								</div>
								
								<div class="row">
									<div class="col-md-4"><p>Awarded Price: ${$WonTender.PriceSubmitted}</p></div>
									<div class="col-md-8">&nbsp;</div>
								</div>
			...
			<% end_loop %>
		<% else %>
			<p>No records for lost tenders available</p>
		<% end_if %>
    </div>
</section>
