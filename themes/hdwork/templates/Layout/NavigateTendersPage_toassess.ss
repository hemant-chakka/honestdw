<section>
   <div id="NavTenders" class="container">
   		<h2>My Tenders - To Assess</h2>
   		$Message
		<% if $ToAssessTenders %>
			<% loop $ToAssessTenders %>
				<div class="row">
					<div class="col-md-2">
						<% if $Images %>
							<% loop $Images %>
					...
					<div class="col-md-10">
						...
						<div class="row">
							...
							<div class="col-md-2">&nbsp;</div>
							<div class="col-md-2"><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#extendTender_{$ID}">Relist Tender</button></div>
							<div class="col-md-4">&nbsp;</div>
						</div>
    							...
    							<% loop $SubmissionsAssess %>
								    <tr>
									    ...
									    <td>AV</td>
      									...
      									<td><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#awardTender_{$TenderID}_{$ID}">Award</button></td>
    								</tr>
    								<% if $Clarifications %>
    									<tr>
			...
			<% end_loop %>
		<% else %>
			<p>No records of tenders available to be assessed.</p>
		<% end_if %>
    </div>
</section>
