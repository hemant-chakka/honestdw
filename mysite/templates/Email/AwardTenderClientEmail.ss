...
<body>
	<div id="getting-work-priced">
		...
		<p>You have selected $Submission.Contractor.Name as the successful Tenderer for the following Tender.</p>
		...
		<p>The next step is for you to make contact with the Contractor and confirm a start date. The Contractors contact details are below:</p>
		<div class="tender-details">
			<ul>
  				<li>$Submission.Contractor.Name</li>
  				<li>$Submission.Contractor.PhoneNumber</li>
  				<li>$Submission.Contractor.Email</li>
			</ul>
		</div>
