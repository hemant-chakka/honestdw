...
<body>
	<div id="getting-work-priced">
		...
		<p><b>Welcome</b></p>
		<p>Welcome to Honest Day's Work.</p>
		<p>Looking for a Contractor to do a job? - click <a href="{$AbsoluteBaseURL}get-prices">here</a>.</p>
		<p>You're a Contractor looking for work? - click <a href="{$AbsoluteBaseURL}home/doSearch">here</a>.</p>
		<p>Got questions? Try our <a href="{$AbsoluteBaseURL}about/frequently-asked-questions/">FAQ</a>.</p>
		<br>
