...
<body>
	<div id="getting-work-priced">
		...
		<p><b>Tender Withdrawn</b></p>
		<p>The Purchaser has withdrawn the tender below.</p>
		<p><a href="{$AbsoluteBaseURL}">Search</a> for more work opportunities.</p>
