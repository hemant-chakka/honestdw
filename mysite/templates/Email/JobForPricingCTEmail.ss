...
<title>Job for Pricing - Closed Tender</title>
<style>
body{
	font-size: 11.0pt;
...
<body>
	<div id="getting-work-priced">
		...
		<p><b>Job for Pricing - Closed Tender</b></p>
		<p>This is a closed Tender and you have been specifically selected by the purchaser to price this work.</p>
		<p>To submit a price <a href="{$AbsoluteBaseURL}Security/login">Login</a> to Honest Day's Work.</p>
		<p>If you are a new user <a href="{$AbsoluteBaseURL}register">Registration</a> is quick and free and will ensure you receive updates for future work opportunities.</p>
		...
		<p>If you have questions about Honest Day's Work either browse through our <a href="{$AbsoluteBaseURL}about/frequently-asked-questions/">FAQs</a>, <a href="{$AbsoluteBaseURL}about/contact/">Contact</a> us on our website link or directly by <a href="mailto:admin@honestdayswork.nz">email</a>.</p>
